...
@push('js')
<script>
    // Fungsi untuk membuka modal dan menampilkan konten berdasarkan URL
    ...
    $(document).ready(function(){
        ...
        dataSupplier = $('#table_supplier').DataTable({
            ...
            ajax: {
                ...
                "type": "POST",
                "data": function (d) {
                    // Di sini bisa tambahkan filter tambahan jika ada, misal supplier_id
                }
            },
            columns: [
                {
        ...
        // Reload otomatis ketika modal ditutup
        $('#myModal').on('hidden.bs.modal', function () {
            dataSupplier.ajax.reload(null, false); // reload tanpa reset pagination
        });
    });
</script>
@endpush
